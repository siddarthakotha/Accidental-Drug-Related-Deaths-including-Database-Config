...
@Document(collection="deathPersonDetailsPrivate")
public class DeathPersonDetailsPrivate {
	...
	public String toString() {
		return "DeathPersonDetailsPrivate [fileId=" + fileId + ", caseNumber=" + caseNumber + ", sex=" + sex + ", race="
				+ race + ", age=" + age + ", deathState=" + deathState + ", cause=" + cause + ", heroin=" + heroin
